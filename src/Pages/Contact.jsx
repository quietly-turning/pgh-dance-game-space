function ContactPage(){
  ...
  <div id="contact">
    ...
    <p>
      Please join and introduce yourself in <code>#introductions</code> if
      you'd like to learn more.
    </p>

    <div className="mt-4 mb-4 d-flex justify-content-center">
      <a className="btn joinDiscordBtn d-flex align-items-center" href="https://discord.gg/73MTHhZ">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="col-2" >
        ...
        <span>Join PA Rhythm Gaming</span>
      </a>
    </div>
